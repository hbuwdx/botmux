...
const zh: DashboardMessages = {
  ...
  'botDefaults.brandLabel': '品牌标识（卡片页脚）',
  'botDefaults.brandLabelHelp': '该 bot 发出的卡片页脚标识。留空保存＝关闭品牌；填写＝自定义（支持 markdown，如 [Acme](https://…)）；恢复默认＝显示 botmux。',
  'botDefaults.brandLabelPlaceholder': '默认：botmux（留空则不显示）',
  'botDefaults.brandSave': '保存品牌',
...
const en: DashboardMessages = {
  ...
  'botDefaults.brandLabel': 'Brand Label (card footer)',
  'botDefaults.brandLabelHelp': 'Footer label on cards this bot sends. Save empty = hide brand; fill in = custom (markdown ok, e.g. [Acme](https://…)); Reset = show botmux.',
  'botDefaults.brandLabelPlaceholder': 'Default: botmux (empty = hidden)',
  'botDefaults.brandSave': 'Save Brand',
