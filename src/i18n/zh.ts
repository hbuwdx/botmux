...
export const messages: Record<string, string> = {
  ...
  'cmd.grant.usage': '用法：@机器人 /grant @某人（授权 ta 在本群与我对话）｜@机器人 /grant（授权本群所有成员对话）。仅授对话权，敏感操作仍由 allowedUsers 控制。',
  ...
  'cmd.revoke.usage': '用法：@机器人 /revoke @某人（撤销 ta 的本群对话权）｜@机器人 /revoke（撤销本群整群对话授权）。',
  ...
  'help.grant': '@机器人 /grant @某人   - 授权对方在本群对话；/grant（不带人）授权本群所有成员对话',
  'help.revoke': '@机器人 /revoke @某人  - 撤销对方本群对话权；/revoke（不带人）撤销整群授权',
  ...
  'setup.supported_clis': '支持的 CLI: 1) claude-code  2) aiden  3) coco  4) codex  5) cursor  6) gemini  7) opencode  8) antigravity  9) mtr',
