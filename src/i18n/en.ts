...
export const messages: Record<string, string> = {
  ...
  'cmd.grant.usage': 'Usage: @bot /grant @someone (let them talk to me in this chat) | @bot /grant (let every member of this chat talk). Talk-only; sensitive ops stay governed by allowedUsers.',
  ...
  'cmd.revoke.usage': 'Usage: @bot /revoke @someone (revoke their talk access in this chat) | @bot /revoke (revoke the whole-chat talk grant).',
  ...
  'help.grant': '@bot /grant @someone   - Let them talk in this chat; /grant (no target) opens the whole chat to talk',
  'help.revoke': '@bot /revoke @someone  - Revoke their talk access; /revoke (no target) revokes the whole-chat grant',
  ...
  'setup.supported_clis': 'Supported CLIs: 1) claude-code  2) aiden  3) coco  4) codex  5) cursor  6) gemini  7) opencode  8) antigravity  9) mtr',
